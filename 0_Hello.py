...
st.write("# Welcome to Predictinator-BV5000 !")
...
st.markdown('<div style="text-align: justify;"><a href="https://github.com/ValentinAdam/Licenta_Poluare">Here is the link to this bachelor thesis</a></div>', unsafe_allow_html=True)
